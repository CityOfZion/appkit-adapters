...
export class AppKitHelper {
  ...
  static setup() {
    createAppKit({
      ...
      networks: Object.values(ChainHelper.networksByChain).flat() as [
        AppKitNetwork,
        ...AppKitNetwork[],
      ],
      adapters: [
      ...
      universalProviderConfigOverride:
        this.mergeUniversalProviderConfigOverride(
  ...
  static mergeUniversalProviderConfigOverride(
    ...overrides: TUniversalProviderConfigOverride[]
